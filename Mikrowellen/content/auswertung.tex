...
\begin{figure}
    \centering
    \includegraphics[width=1.2\textwidth]{build/mode.pdf}
...
Aus der gemessenen Frequenz in Tabelle \ref{tab:wel} und der bestimmten Wellenlänge \eqref{eqn:well} lässt sich die Phasengeschwindigkeit über
\begin{equation}
    \label{eqn:v_p}
